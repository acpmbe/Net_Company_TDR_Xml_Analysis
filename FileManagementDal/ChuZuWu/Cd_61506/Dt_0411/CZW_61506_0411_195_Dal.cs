...
{
    public class CZW_61506_0411_195_Dal
    {
        ...
        /// <returns></returns>
        public static CZW_61506_0411_195_Mod GetMod(byte[] content)
        {


            CZW_61506_0411_195_Mod info = new CZW_61506_0411_195_Mod();
        ...
        private static CZW_61506_0411_195_Mod.腿部实体 GetLegMod(byte[] content)
        {
            CZW_61506_0411_195_Mod.腿部实体 info = new CZW_61506_0411_195_Mod.腿部实体();
            if (content.Length == 2)
            {
                info.拐点时间 = content[0];
        ...
        private static CZW_61506_0411_195_Mod.手臂实体 GetArmMod(byte[] content)
        {
            CZW_61506_0411_195_Mod.手臂实体 info = new CZW_61506_0411_195_Mod.手臂实体();
            if (content.Length == 3)
            {
                info.拐点时间 = content[0];
        ...
        private static CZW_61506_0411_195_Mod.肩膀实体 GetShoulderMod(byte[] content)
        {
            CZW_61506_0411_195_Mod.肩膀实体 info = new CZW_61506_0411_195_Mod.肩膀实体();
            if (content.Length == 4)
            {
                info.拐点时间 = content[0];
        ...
        private static CZW_61506_0411_195_Mod.面部实体 GetFaceMod(byte[] content)
        {
            CZW_61506_0411_195_Mod.面部实体 info = new CZW_61506_0411_195_Mod.面部实体();
            if (content.Length == 3)
            {
                info.拐点时间 = content[0];
        ...
        private static CZW_61506_0411_195_Mod.头部实体 GetHeadMod(byte[] content)
        {
            CZW_61506_0411_195_Mod.头部实体 info = new CZW_61506_0411_195_Mod.头部实体();
            if (content.Length == 6)
            {
