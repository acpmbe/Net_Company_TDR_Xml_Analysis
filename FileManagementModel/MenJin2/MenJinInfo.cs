...
namespace FileManagementModel.MenJin2
{
    public class MenJinInfo
    {
        ...
        public string pi_lordcardtype { get; set; }
        public string pi_lordcardid { get; set; }
        public string pi_lordidentitycard { get; set; }
        public string pi_lordidentitycardid { get; set; }
        public string pi_cardtype { get; set; }
        public string pi_cardid { get; set; }
        public string pi_identitycard { get; set; }
        public string pi_identitycardid { get; set; }
        public string pi_houseno { get; set; }
        public string pi_roomno { get; set; }
