...
using FileManagement.Commands.LvYe;
...
namespace FileManagement.Factory
{
    ...
    //public class ZNQTFactory: ICommandFactory
    //{

    //    private IXmlFormat xmlFormat;
    //    public ZNQTFactory(IXmlFormat xmlFormat)
    //    {
    ...
    //        {
    //            case "61443":
    //                cmd = new ZNQT_61443(_content, StationId, PlatformTime);
    //                break;
    //            default:
