...
{
    public class Pro_IndateBase_ZHMJ_Bll  
    {
        private Pro_IndateBase_ZHMJ_Mod Info;

        public Pro_IndateBase_ZHMJ_Bll(Pro_IndateBase_ZHMJ_Mod info)
        {
            this.Info =info;
        }
        ...
        public string Exec()
        {
            ...
            Pro_IndateBase_ZHMJ_Dal.Exec(this.Info, out resultnum, out reason, out status, out wechatid, out alarmcontent);
