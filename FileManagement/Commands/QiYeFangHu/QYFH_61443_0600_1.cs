...
{
    public class QYFH_61443_0600_1 : ICommand
    {
        ...
        public QYFH_61443_0600_1(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                QiYeFangHuDal.Insert_XinTiao(DeviceTypeStr, DeviceIdStr, temperatureStr, HumidityStr, timeStr, DeviceStateStr);
