...
{
    public class LV_61506_0419_195 : ICommand
    {
        ...
        public LV_61506_0419_195(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public bool Execute()
        {
            try
            {
                ...
                LV_61506_0419_195_Mod Cm = LV_61506_0419_195_Dal.GetMod(this._content);
                Cm.基站编号 = (uint)StationId;
                Cm.平台时间 = this.PlatformTime;

                Pro_IndataBase_ZNMP_Mod info = LV_61506_0419_195_Dal.Get_Pro_Mod(Cm);
