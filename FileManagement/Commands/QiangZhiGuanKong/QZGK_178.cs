...
{
    public class QZGK_178 : ICommand
    {
        ...
        public QZGK_178(string _cmdId, byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
            this.CmdId = _cmdId;
        ...
        private string Name { get { return "上传GPRS信息（备份）"; } }
