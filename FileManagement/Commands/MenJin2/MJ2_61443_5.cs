...
{
    public class MJ2_61443_5 : ICommand
    {
        ...
        public MJ2_61443_5(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public const string NAME = "删卡（一级房东卡）";
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                string UserIdentitycardId = ConverUtil.ByteToStr_Q(_content, 7, 8); //身份证Id.
                string Identitycard = SFZUtil.ByteToStr(_content, 15); //身份证。
