...
{
  public  class MJ2_61445: ICommand
    {
        ...
        public MJ2_61445(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public bool Execute()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                content = new byte[45];
                Array.Copy(_content, 2 + (length * i), content, 0, 45);
                ICommand cmd;
                switch (commandId)
                {
                    case "1":
                    ...
                    case "10":
                        ...
                        break;
                    case "12":
                        cmd = new MJ2_61445_12(content, StationId, PlatformTime);
                        break;    
                    default:
