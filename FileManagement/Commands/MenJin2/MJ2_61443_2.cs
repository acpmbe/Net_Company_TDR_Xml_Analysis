...
{
    public class MJ2_61443_2 : ICommand
    {
        ...
        public MJ2_61443_2(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public const string NAME = "添卡（二级房东卡）";
        public bool Execute()
        {
            ...
            try
            {
                ...
                string OneHoneNumCardType = _content[6].ToString();     //一级房东卡类型
                string OneHoneNumIdentitycardId = ConverUtil.ByteToStr_Q(_content,7,8); //一级房东卡身份证ID.
                ...
                info.pi_lordcardtype = OneHoneNumCardType;
                info.pi_lordidentitycardid = OneHoneNumIdentitycardId;
