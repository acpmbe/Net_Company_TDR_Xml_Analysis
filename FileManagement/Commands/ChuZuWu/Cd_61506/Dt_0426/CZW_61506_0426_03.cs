...
namespace FileManagement.Commands.ChuZuWu.Cd_61506.Dt_0426
{
    ...
    /// 逻辑处理（NFC_删卡）
    /// </summary>
    public class CZW_61506_0426_03:ICommand
    {
        ...
        public CZW_61506_0426_03(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public const string NAME = "NFC_删卡";
        ...
        public bool Execute()
        {
            try
            {
                ...
                CZW_61506_0426_03_Mod Cm = CZW_61506_0426_03_Dal.GetMod(this._content);
                Cm.基站编号 = (uint)StationId;
                Cm.平台时间 = this.PlatformTime;

                Pro_InDatabase_NFC_Mod info = CZW_61506_0426_03_Dal.Get_Pro_Mod(Cm);
