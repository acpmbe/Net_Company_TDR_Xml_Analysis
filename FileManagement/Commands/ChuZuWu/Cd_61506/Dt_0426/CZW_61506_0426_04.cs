...
namespace FileManagement.Commands.ChuZuWu.Cd_61506.Dt_0426
{
    ...
    /// 逻辑处理（NFC_刷卡记录）
    /// </summary>
    public class CZW_61506_0426_04:ICommand
    {
        ...
        public CZW_61506_0426_04(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public const string NAME = "NFC_刷卡记录";
        ...
        public bool Execute()
        {
            try
            {
                ...
                CZW_61506_0426_04_Mod Cm = CZW_61506_0426_04_Dal.GetMod(this._content);
                Cm.基站编号 = (uint)StationId;
                Cm.平台时间 = this.PlatformTime;

                Pro_InDatabase_NFC_Mod info = CZW_61506_0426_04_Dal.Get_Pro_Mod(Cm);
