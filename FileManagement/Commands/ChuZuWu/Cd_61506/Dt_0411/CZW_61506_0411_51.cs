...
{
    public class CZW_61506_0411_51:ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61506_0411_51(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private readonly string Name = "电子防盗门牌_第五可靠级进门数据采集上传";
        public bool Execute()
        {
