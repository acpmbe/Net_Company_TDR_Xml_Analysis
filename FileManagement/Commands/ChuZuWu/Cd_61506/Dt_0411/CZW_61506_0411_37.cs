...
{
    public class CZW_61506_0411_37:ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61506_0411_37(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private readonly string Name = "电子防盗门牌_第三可靠级出门数据采集上传";
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.Pi_Param8 = _content[29].ToString(); //本次进出门中最大身高（计算值）
                info.Pi_Param9 = _content[30].ToString();  //本次进出门中最大身高(实测值)
