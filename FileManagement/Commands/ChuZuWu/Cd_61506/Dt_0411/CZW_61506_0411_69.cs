...
{
   public class CZW_61506_0411_69: ICommand
    {
        ...
        public CZW_61506_0411_69(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private readonly string Name = "电子防盗门牌_第2协议数据_出门习惯采集上传";
        public bool Execute()
        {
