...
{
   public class CZW_61506_0411_53:ICommand
    {
        ...
        public CZW_61506_0411_53(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private readonly string Name = "电子防盗门牌_第五可靠级出门数据采集上传";
        public bool Execute()
        {
