...
namespace FileManagement.Commands.ChuZuWu.Cd_61506.Dt_0411
{
    ...
    /// 逻辑处理（心跳数据上传）
    /// </summary>
    public class CZW_61506_0411_177 : ICommand
    {
        ...
        public CZW_61506_0411_177(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public const string NAME = "电子防盗门牌_心跳数据上传";
