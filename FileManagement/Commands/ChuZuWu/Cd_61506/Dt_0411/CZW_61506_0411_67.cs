...
{
    public class CZW_61506_0411_67: ICommand
    {
        ...
        public CZW_61506_0411_67(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private readonly string Name = "电子防盗门牌_第2协议数据_进门习惯采集上传";
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.Pi_Param11 = _content[24].ToString(); //进入超声波侦测场时身高
                info.Pi_Param12 = ConverUtil.ByteToStr_2(_content, 25);  //关联0x13协议的CRC值
                info.Pi_Param13 = _content[29].ToString(); //进出门校准最大身高
                info.Pi_Param14 = _content[30].ToString(); //进出门实测最大身高
                info.Pi_Param15 = _content[31].ToString(); //对地校准值
