...
namespace FileManagement.Commands.ChuZuWu.Cd_61506.Dt_0411
{
    ...
    /// 逻辑处理（单人进出协议数据上传）
    /// </summary>
    public class CZW_61506_0411_197:ICommand
    {
        ...
        public CZW_61506_0411_197(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        public bool Execute()
        {
            try
            {
                ...
                CZW_61506_0411_197_Mod Cm = CZW_61506_0411_197_Dal.GetMod(this._content);
                Cm.基站编号 = (uint)StationId;
                Cm.平台时间 = this.PlatformTime;

                Pro_IndataBase_ZNMP_Mod info = CZW_61506_0411_197_Dal.Get_Pro_Mod(Cm);
