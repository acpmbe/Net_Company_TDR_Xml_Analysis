...
{
    public class CZW_61504_0430_07 : ICommand
    {
        ...
        public CZW_61504_0430_07(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "智慧刷卡门戒_人数清零上传"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = _content[14].ToString();    //人数归零前房间内的人数
