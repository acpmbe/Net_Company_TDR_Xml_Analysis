...
{
    public class CZW_61504_0430_04 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61504_0430_04(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "智慧刷卡门戒_剧烈震动报警"; } }
        public bool Execute()
        {
