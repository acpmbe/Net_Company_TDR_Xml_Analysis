...
{
    public class CZW_61504_0430_14 : ICommand
    {
        ...
        public CZW_61504_0430_14(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "智慧刷卡门戒_用户卡删除"; } }
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_activecardid = ConverUtil.ByteToStr_4(_content, 23); // 设备Id
