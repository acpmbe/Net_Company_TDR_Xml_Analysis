...
namespace FileManagement.Commands.ChuZuWu
{
    public class CZW_543 : ICommand
    {
        ...
        public CZW_543(string _cmdId, byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
            this.CmdId = _cmdId;
        ...
        private string Name { get { return "离线房东授权批量上传"; } }
        ...
        private Pro_IndateBase_MJNew_Mod GetInfo_New()
        {
            ...
            string[] PoliceArray = new string[Count];  //警察卡数组。
            byte[] Data;
            int IsIdentitycard;                       //索引。
            for (int i = 0; i < Count; i++)
            {
                ...
                PoliceArray[i] = ConverUtil.ByteToStr_4(Data, 9);
            ...
            info.pi_policecard = ConverUtil.GetArrayToStr(PoliceArray);
