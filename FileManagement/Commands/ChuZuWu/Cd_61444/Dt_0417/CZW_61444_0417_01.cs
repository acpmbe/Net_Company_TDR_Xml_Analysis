...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0417
{
    public class CZW_61444_0417_01 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0417_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "KTV噪音检测心跳"; } }
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = _content[14].ToString();  //歌曲播放状态
