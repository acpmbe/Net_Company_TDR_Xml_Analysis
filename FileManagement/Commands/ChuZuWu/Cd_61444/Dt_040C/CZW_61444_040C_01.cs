...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_040C
{
    public class CZW_61444_040C_01 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_040C_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "电动车充电心跳"; } }
        ...
        public bool Execute()
        {
            try
            {
                ...
                info.pi_param3 = DataJM.功率因素(_content, 15);  //功率因素
