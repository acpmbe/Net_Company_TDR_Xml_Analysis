...
{
    public class CZW_61444_040C_04 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_040C_04(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "电动车充电完成报警"; } }
        public bool Execute()
        {
            try
            {
