...
{
    public class CZW_61444_0440_02 : ICommand
    {
        ...
        public CZW_61444_0440_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "商铺卷门防盗震动报警"; } }
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = ConverUtil.ByteToStr_2(_content, 15); //三轴的模值之和
