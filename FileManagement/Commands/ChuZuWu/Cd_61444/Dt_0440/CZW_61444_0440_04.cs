...
{
    public class CZW_61444_0440_04 : ICommand
    {
        ...
        public CZW_61444_0440_04(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "商铺卷门防拆报警"; } }
        public bool Execute()
        {
