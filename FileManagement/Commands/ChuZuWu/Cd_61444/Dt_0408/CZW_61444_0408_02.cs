...
{
    public class CZW_61444_0408_02 : ICommand
    {
        ...
        public CZW_61444_0408_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "门戒报警"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = _content[14].ToString();    //开关状态。
