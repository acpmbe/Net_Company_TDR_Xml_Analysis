...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0410
{
    public class CZW_61444_0410 : ICommand
    {
        ...
        public CZW_61444_0410(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "声光报警心跳"; } }
        public bool Execute()
        {
