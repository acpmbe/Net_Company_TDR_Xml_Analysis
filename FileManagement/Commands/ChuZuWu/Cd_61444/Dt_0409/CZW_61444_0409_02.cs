...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0409
{
    public class CZW_61444_0409_02 : ICommand
    {
        ...
        public CZW_61444_0409_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "红外防盗报警"; } }
        public bool Execute()
        {
            try
            {
