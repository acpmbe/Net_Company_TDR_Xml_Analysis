...
{
    public class CZW_61444_0409_01 : ICommand
    {
        ...
        public CZW_61444_0409_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "红外防盗心跳"; } }
        public bool Execute()
        {
            try
            {
