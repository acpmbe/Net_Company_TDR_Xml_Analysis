...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0480
{
    public class CZW_61444_0480_02 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0480_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "红外防盗终端报警"; } }
        public bool Execute()
        {
            try
            {
                ...
                info.pi_param1 = _content[14].ToString();     //设备状态
