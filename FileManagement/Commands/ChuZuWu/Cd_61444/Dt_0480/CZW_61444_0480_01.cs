...
{
    public class CZW_61444_0480_01 : ICommand
    {
        ...
        public CZW_61444_0480_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "红外防盗终端心跳"; } }
        public bool Execute()
        {
            try
            {
