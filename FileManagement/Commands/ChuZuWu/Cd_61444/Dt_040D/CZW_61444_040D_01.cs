...
{
    public class CZW_61444_040D_01 : ICommand
    {
        ...
        public CZW_61444_040D_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "无线按钮心跳"; } }
        public bool Execute()
        {
