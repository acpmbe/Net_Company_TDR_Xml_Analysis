...
{
    public class CZW_61444_0407_01 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0407_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "烟感心跳"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param4 = DataJM.温度(_content, 17);     //温度。
