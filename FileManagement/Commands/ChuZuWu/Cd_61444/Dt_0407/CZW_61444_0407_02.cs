...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0407
{
    public class CZW_61444_0407_02 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0407_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "烟感报警"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = DataJM.温度(_content, 14);    //温度。
