...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_040A
{
    public class CZW_61444_040A_01 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_040A_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "窗戒心跳"; } }
        public bool Execute()
        {
            try
            {
