...
namespace FileManagement.Commands.ChuZuWu.Cd_61444.Dt_0406
{
    public class CZW_61444_0406_04 : ICommand
    {
        ...
        public CZW_61444_0406_04(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "用电管控A功率超过阀值报警"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_param1 = _content[14].ToString();
                info.pi_param2 = ConverUtil.ByteToStr_2(_content, 15);  //功率大小
              //  info.pi_param3 = ((short)ConverUtil.ByteToInt_2(_content, 17)).ToString();  //功率变化量

                info.pi_param3 = ConverUtil. GetGongLv( ConverUtil.ByteToInt_2(_content, 17));  //功率变化量
