...
{
    public class CZW_61444_0406_10 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0406_10(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "用电管控A功率频繁切换报警"; } }
        public bool Execute()
        {
