...
{
    public class CZW_61444_0406_02 : ICommand
    {
        ...
        public CZW_61444_0406_02(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "用电管控A功率过大报警"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_devicecode= ConverUtil.ByteToStr_4(_content, 9);  //设备Id
                info.pi_protocoltype = _content[13].ToString();   
                info.pi_param1 = ConverUtil.ByteToStr_2(_content, 14);     //功率大小。
                info.pi_param2 = DataJM.gonglvyinsu(_content[16].ToString());  //功率因素
