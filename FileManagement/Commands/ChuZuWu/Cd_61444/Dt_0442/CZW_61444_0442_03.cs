...
{
    public class CZW_61444_0442_03 : ICommand
    {
        private byte[] _content;
        private ulong StationId;
        private DateTime PlatformTime;
        private string OriginalCode;
        public CZW_61444_0442_03(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "商铺推门特大幅度报警"; } }
        public bool Execute()
        {
