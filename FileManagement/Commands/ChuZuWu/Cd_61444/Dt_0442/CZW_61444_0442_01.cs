...
{
    public class CZW_61444_0442_01 : ICommand
    {
        ...
        public CZW_61444_0442_01(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "商铺推门防盗心跳"; } }
        public bool Execute()
        {
