...
namespace FileManagement.Commands.ChuZuWu
{
    public class CZW_526 : ICommand
    {
        ...
        public CZW_526(byte[] _content, ulong _StationId, DateTime _PlatformTime)
        {
        ...
        private string Name { get { return "出租房管理终端_上传租客2"; } }
        ...
        public bool Execute()
        {
            ...
            try
            {
                ...
                info.pi_identitycardid = ConverUtil.ByteToStr_Q(_content, 12, 8);      //亲友身份证ID   
