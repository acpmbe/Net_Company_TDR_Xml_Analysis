...
{
    public class MenJinKaShouQuanCommand:ICommand
    {        
        ...
        public MenJinKaShouQuanCommand(string _devid, byte[] _content)
        {
        ...
        private string Name { get { return "门禁授权"; } }
        public bool Execute()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    int resultNo;
                    string ResultInfo;
                    MenJinShouQuanDal.Insert(Devid, sqkNumberInt, 1, out resultNo, out ResultInfo);
                    if (resultNo == 1)
                    {
